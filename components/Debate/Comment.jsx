...
export default function Comment({ debateId, onClose, userName, userId }) {
    ...
    const handleSendComment = async () => {
        ...
        if (!debateId || !userName || !userId) {
            Alert.alert('Error', 'Missing required information. Please try again.');
            console.error('Missing required information:', { debateId, userName, userId });
            return;
        }
